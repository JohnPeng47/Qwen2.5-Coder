...
"""
    ...
    for id, code_block in code_blocks:
        ...
        print(prompt.format(code_block=code_block))
        break
    ...
    # json.dump(qa_data_output, open(f"qa_data/{model_name}_{qa_num}_{'chunked' if chunked else 'file'}_{'reason' if reasoning else 'noreason'}.json", "w"))
...
if __name__ == "__main__":
    ...
    create_qa_pairs(repo_path, code_blocks, args.model_name, int(args.qa_num), chunked=args.chunked, reasoning=False)
